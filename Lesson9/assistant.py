...
assistant = client.beta.assistants.retrieve(assistant_id = "asst_FANWSczvwTSKpuAeTDCm0TdM")

# file = client.vector_stores.files.create_and_poll(
#  vector_store_id="vs_682f7dde49448191a3e5751cbb6600af",
#  file_id="file-LKhqXGDSNhKfF439uytUyz"
# )
...
while True:
    ...
    selfharm_threshold = 0.8

    print(moderation_result.results[0])
    while moderation_result.results[0].category_scores.self_harm > selfharm_threshold or moderation_result.results[0].flagged == True:
